...
//        String deleteSql = "delete from 表名";
        ...
        String Sql = "INSERT INTO log (deviceid,info,devicevalue,state,ing,lat,logtimestamp)" +
                "VALUES" +
                "(\"" + msg.getClientId() +
                "\",\"" + msg.getInfo() +
                "\"," + msg.getValue() +
...
//        System.out.println(Sql);
        ...
        dbHelper.close();
        String Sql2 = "UPDATE device SET state = "
                + msg.getAlert()
                + " WHERE deviceid = '"
                + msg.getClientId() + "'";
//        System.out.println(Sql);
        ...
        String Sql3 = "INSERT INTO device (deviceid) VALUES ('" + msg.getClientId() + "')";
